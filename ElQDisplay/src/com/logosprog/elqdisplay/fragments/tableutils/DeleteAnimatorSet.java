...
/**
 * This class plays a set of {@link android.animation.Animator} objects in the specified order. Animations
 * can be set up to play together, in sequence, or after a specified delay.
 *
 * <p>There are two different approaches to adding animations to a <code>AnimatorSet</code>:
 * either the {@link DeleteAnimatorSet# playTogether(android.animation.Animator[]) playTogether()} or
 * {@link DeleteAnimatorSet# playSequentially(android.animation.Animator[]) playSequentially()} methods can be called to add
 * a set of animations all at once, or the {@link DeleteAnimatorSet# play(android.animation.Animator)} can be
 * used in conjunction with methods in the {@link DeleteAnimatorSet.Builder Builder}
 ...
 * </div>
 */
public final class DeleteAnimatorSet extends Animator {
    ...
    /**
     * An object to return in {@link com.logosprog.elqdisplay.fragments.tableutils.DeleteAnimatorSet.DeleteAnimatorSetListener#onAnimationEnd(Object)} callback
     */
    private Object retObject;

    public DeleteAnimatorSet(Object obj){
        this.retObject = obj;
        deleteAnimatorSetListeners = new ArrayList<>();
    }
     ...
     * of this AnimatorSet that take targets ({@link android.animation.ObjectAnimator} and
     * AnimatorSet).
     *
    ...
    public void setTarget(Object target) {
        for (Node node : mNodes) {
            ...
            if (animation instanceof DeleteAnimatorSet) {
                ((DeleteAnimatorSet)animation).setTarget(target);
    ...
    public void end() {
        ...
        if (isStarted()) {
            ...
            if (mListeners != null) {
                ...
                for (DeleteAnimatorSetListener listener : deleteAnimatorSetListeners){
                    listener.onAnimationEnd(retObject);
                }
            }
            mStarted = false;
        }
     ...
     */
    @Override
    public DeleteAnimatorSet setDuration(long duration) {
        if (duration < 0) {
    ...
    @Override
    public DeleteAnimatorSet clone() {
        final DeleteAnimatorSet anim = (DeleteAnimatorSet) super.clone();
        /*
    ...
    private static class DependencyListener implements AnimatorListener {
        ...
        private DeleteAnimatorSet mAnimatorSet;
        ...
        public DependencyListener(DeleteAnimatorSet deleteAnimatorSet, Node node, int rule) {
            this.mAnimatorSet = deleteAnimatorSet;
            this.mNode = node;
            this.mRule = rule;
        }
    ...
    private class AnimatorSetListener implements AnimatorListener {
        ...
        AnimatorSetListener(DeleteAnimatorSet deleteAnimatorSet) {
            mAnimatorSet = deleteAnimatorSet;
        }
     ...
     * DeleteAnimatorSet# play(android.animation.Animator) play()} method of <code>AnimatorSet</code> is to make it possible
     * to express the dependency relationships of animations in a natural way. Developers can also
     * use the {@link DeleteAnimatorSet# playTogether(android.animation.Animator[]) playTogether()} and {@link
     * DeleteAnimatorSet# playSequentially(android.animation.Animator[]) playSequentially()} methods if these suit the need,
     * but it might be easier in some situations to express the AnimatorSet of animations in pairs.
     * <p/>
     * <p>The <code>Builder</code> object cannot be constructed directly, but is rather constructed
     * internally via a call to {@link DeleteAnimatorSet# play(android.animation.Animator)}.</p>
     * <p/>
     ...
     * </pre>
     * <p/>
     * <p>Note in the example that both {@link DeleteAnimatorSet.Builder# before(android.animation.Animator)} and {@link
     * DeleteAnimatorSet.Builder# after(android.animation.Animator)} are used. These are just different ways of expressing the same
     * relationship and are provided to make it easier to say things in a way that is more natural,
     * depending on the situation.</p>
     * <p/>
     * <p>It is possible to make several calls into the same <code>Builder</code> object to express
     * multiple relationships. However, note that it is only the animation passed into the initial
     * {@link DeleteAnimatorSet# play(android.animation.Animator)} method that is the dependency in any of the successive
    ...
    public class Builder {
         ...
         * {@link DeleteAnimatorSet# play(android.animation.Animator)} call that created this <code>Builder</code> object.
         *
         * @param anim The animation that will play when the animation supplied to the
         * {@link DeleteAnimatorSet# play(android.animation.Animator)} method starts.
         */
         ...
         *
         * @param anim The animation that will play when the animation supplied to the
         * {@link DeleteAnimatorSet# play(android.animation.Animator)} method ends.
         */
         ...
         * {@link DeleteAnimatorSet# play(android.animation.Animator)} method to play.
         */
    ...
    private List<DeleteAnimatorSetListener> deleteAnimatorSetListeners;

    public void addDeleteAnimatorSetListener(DeleteAnimatorSetListener listener){
        deleteAnimatorSetListeners.add(listener);
    }

    public interface DeleteAnimatorSetListener{
